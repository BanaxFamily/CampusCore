...
import AdminLinks from './administrator/AdminLinks'
export const Header = () => {
    ...
    return (
        <nav className="sticky top-0 bg-white shadow-xl pb-2">
            <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
                <div className="relative flex h-16 items-center justify-between">
                    <div className="sm:hidden absolute inset-y-0 left-0 flex items-center ">
                        {/* <!-- Mobile menu button--> */}
                        <button onClick={openMobileMenu} type="button" className="relative inline-flex items-center justify-center rounded-md p-2 text-gray-400 focus:bg-gray-700 hover:text-white focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white" aria-controls="mobile-menu" aria-expanded="false">
                    ...
                    <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                        <div className="flex flex-shrink-0 items-center">
                            ...
                            <span className=' hidden sm:block absolute bottom-0 left-16 text-[8px] font-semibold '>
            ...
            {
                mobileMenu &&
                <div className='fixed w-full h-screen flex flex-col justify-center items-center
                    bg-white/90 z-20
                '>
                    <AdminLinks onClick={openMobileMenu} classname="w-[75%] flex justify-center border border-slate-700"/>
                </div>
            }
