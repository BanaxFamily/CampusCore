...
export const Register = () => {
  return (
    <>
      <div className="w-full flex text-gray-300 group">
        <Link
          to=".."
          path="relative"
          className="flex flex-row-reverse items-center group-hover:text-gray-400 underline underline-offset-2 text-sm md:text-[10]"
        >
          Back
          <BsArrowBarLeft />
        </Link>
      ...
      <div
        className=" w-full m-auto border border-slate-600 overflow-hidden 
                  bg-white h-auto md:mt-4 md:h-fit md:w-[65%] flex flex-col rounded-md"
      >
            ...
            <form action="">
              <div className="w-full flex justify-start gap-4 md:gap-2">
                <div className="flex flex-col justify-center w-1/2">
                  ...
                  <input
                    className=" bg-gray-300 rounded-lg w-[140px] md:w-full mr-2 py-2 px-4 md:py-1"
                    type="text"
                    name="firstname"
                    placeholder="Paul"
                    id="firstname"
